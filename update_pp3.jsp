...
try{
    ...
    String pp3t = request.getParameter("pp3t");
    ...
    if(i==0){
            ...
            String addQuery = "INSERT INTO user_pics (auth_id, pp3, pp3t, ppm, ppmt, pp1, pp1t, pp2, pp2t)"+
                " VALUES( '"+ 
                auth_id + "','" + pp3 + "','" + pp3t + "','','' ,'','','','')";
        ...
        String updateQuery = "UPDATE user_pics SET pp3='" + pp3 + "', pp3t='"+ pp3t +
