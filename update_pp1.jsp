...
try{
    ...
    String pp1t = request.getParameter("pp1t");
    ...
    if(i==0){
            ...
            String addQuery = "INSERT INTO user_pics (auth_id, pp1, pp1t, ppm, ppmt, pp2, pp2t, pp3, pp3t)"+
                " VALUES( '"+ 
                auth_id + "','" + pp1 + "','" + pp1t + "','','' ,'','','','')";
        ...
        String updateQuery = "UPDATE user_pics SET pp1='" + pp1 + "', pp1t='"+ pp1t +
